...
// ERC20 ABI – includes mint for MockUSDC testing
const ERC20_ABI = [
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] pt-12 pb-20 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Balance Card */}
        <div className="bg-white p-4 rounded-xl border border-[#EBE6E0] shadow-sm mb-6 flex justify-between items-center">
        ...
        {/* Main Card */}
        <div className="bg-white p-8 sm:p-10 rounded-[2rem] shadow-md border border-[#EBE6E0]">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3.5 bg-[#F5F0E6] rounded-2xl text-[#A38A63]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 10a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z" /></svg>
            </div>
            <div>
          ...
          <form onSubmit={handleFund} className="flex flex-col gap-6">
            ...
            {/* Mint Button – only shown if balance is low (optional) */}
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-6 rounded-[1.5rem] bg-[#FAFAF7] border border-[#EBE6E0]">
            <div className="p-2.5 bg-[#F5F0E6] text-[#A38A63] rounded-xl mb-4 inline-block">
          ...
          <div className="p-6 rounded-[1.5rem] bg-[#EDF2EA] border border-[#CDE0C0]">
            <div className="p-2.5 bg-white text-[#5C7A43] rounded-xl mb-4 inline-block">
